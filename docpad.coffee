...
docpadConfig =
	...
	templateData:
		...
		site:
			...
			title: "Драматический театр «Комедианты»"

			# The website description (for SEO)
			description: """
				Драматический театр «Комедианты». Официальный сайт. Санкт-Петербург, Лиговский пр., 44
				"""

			# The website keywords (for SEO) separated by commas
			keywords: """
				театр, билеты, комедианты
				"""
			...
			email: "info@komedianty.com"

			# Your company's name
			copyright: "© ЛОГБУК «Комедианты»"
